...
class RunningAnalysis:
    def __init__(self, db_path):
        self.db_path = r'e:/jheel_dev/DataBasesDev/RunningAnalysis.db'  # Use consistent path
...
def main():
    # Database path
    db_path = 'e:/jheel_dev/DataBasesDev/RunningAnalysis.db'

    # Create analysis object
    analysis = RunningAnalysis('e:/jheel_dev/DataBasesDev/RunningAnalysis.db')
